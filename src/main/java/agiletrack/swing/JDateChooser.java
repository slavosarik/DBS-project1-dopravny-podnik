...
public class JDateChooser extends JPanel {
	...
	public JDateChooser() {
		...
		comboBoxButton = new BasicArrowButton(BasicArrowButton.SOUTH,
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getActionCommand().equalsIgnoreCase("Clicked")) {
				...
				ActionEvent event = new ActionEvent(JDateChooser.this,
						ActionEvent.ACTION_PERFORMED, "changed",
	...
	private class ComboBoxLayout implements LayoutManager {
		...
		public Dimension preferredLayoutSize(Container parent) {
			Dimension dimension = new Dimension(
					comboBoxButton.getPreferredSize().width
							+ dateField.getPreferredSize().width,
					combineDimensions(
							new Dimension[] {
									comboBoxButton.getPreferredSize(),
